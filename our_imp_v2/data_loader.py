...
class SoccerDatasetSequence(Dataset):
    """
    A PyTorch Dataset class adapted for SoccerNet tracking data.
    Images are loaded lazily in __getitem__ so DataLoader workers
    can parallelize I/O, and batches are padded in a custom collate_fn.
